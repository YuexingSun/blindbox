//
//  ZXMineBlindBoxStatisticsView.m
//  ZXHY
//
...
@interface ZXMineBlindBoxStatisticsView ()
...
@implementation ZXMineBlindBoxStatisticsView
...
- (void)zx_dataWithMineModel:(ZXMineModel *)mineModel{
    ...
    if ([dinnerGap isEqualToString:@"0"] && [snackGap isEqualToString:@"0"] && ![play isEqualToString:@"0"]){
        play = [NSString stringWithFormat:@"%0.2f",[play doubleValue] + 0.01];
        playGap = @"0";
    }
    if ([dinnerGap isEqualToString:@"0"] && [playGap isEqualToString:@"0"] && ![snack isEqualToString:@"0"]){
        snack = [NSString stringWithFormat:@"%0.2f",[snack doubleValue] + 0.01];
        snackGap = @"0";
    }
    if ([snackGap isEqualToString:@"0"] && [playGap isEqualToString:@"0"] &&  ![dinner isEqualToString:@"0"]){
    ...
    if ([dinner isEqualToString:@"0.01"] && [snack isEqualToString:@"0.01"] && [play isEqualToString:@"0.01"] ){
        self.cirqueView.valueArray = [NSMutableArray arrayWithObjects:@"1", nil];
        
        self.cirqueView .colorArray = [NSMutableArray arrayWithObjects:WGGrayColor(239), nil];
    }
