...
class GlideEngine : ImageEngine {
     ...
     * [imageView]
     * [longImageView]
     * [callback]       网络图片加载回调监听 {link after version 2.5.1 Please use the #OnImageCompleteCallback#}
     */
    ...
    override fun loadFolderImage(context: Context, url: String, imageView: ImageView) {
        Glide.with(context).asBitmap().load(url).override(180, 180).centerCrop()
            .sizeMultiplier(0.5F).placeholder(R.drawable.ic_login_app).into(
    ...
    override fun loadGridImage(context: Context, url: String, imageView: ImageView) {
        Glide.with(context).load(url).override(200, 200).centerCrop()
            .placeholder(R.drawable.ic_login_app).into(imageView)
    }
