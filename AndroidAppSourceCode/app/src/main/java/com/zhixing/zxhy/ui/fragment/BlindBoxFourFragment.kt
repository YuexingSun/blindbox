    ...
    override fun initView(savedInstanceState: Bundle?) {
        mDataBind.apply {
            ...
            SmartRefreshLayoutA.apply {
                //下拉刷新
                refresh {
                    mViewModel.getMyBoxListData(this, MyBlindBoxListStatus.Four)
                }
                //上拉加载
                loadMore {
                    mViewModel.getMyBoxListData(this, MyBlindBoxListStatus.Four, isRefresh = false)
                }
            }
        }
    }
