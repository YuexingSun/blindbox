    ...
    override fun initView(savedInstanceState: Bundle?) {
        mDataBind.apply {
            ...
            SmartRefreshLayoutA.apply {
                //下拉刷新
                refresh {
                    mViewModel.getMyBoxListData(this, MyBlindBoxListStatus.Three)
                }
                //上拉加载
                loadMore {
                    mViewModel.getMyBoxListData(this, MyBlindBoxListStatus.Three, isRefresh = false)
                }
            }
        }
    }
