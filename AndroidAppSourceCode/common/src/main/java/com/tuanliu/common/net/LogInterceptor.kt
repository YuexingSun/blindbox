...
import com.tuanliu.common.net.log.util.CharacterHandler.Companion.jsonFormat
import com.tuanliu.common.net.log.DefaultFormatPrinter
import com.tuanliu.common.net.log.FormatPrinter
import com.tuanliu.common.net.log.util.UrlEncoderUtils.Companion.hasUrlEncoded
import com.tuanliu.common.net.log.util.ZipHelper.Companion.decompressForGzip
import com.tuanliu.common.net.log.util.ZipHelper.Companion.decompressToStringForZlib
import okhttp3.*
import okio.Buffer
...
class LogInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        originalResponse = try {
            ...
            Timber.d("Http Error: %s", e.message)
            throw e
        }
