...
import org.flower.l.library.view.PasswordView
import java.util.*
    ...
    private class KeyboardAdapter(context: Context) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AppViewHolder {
            return when (viewType) {
                TYPE_DELETE -> SimpleViewHolder(R.layout.item_pay_password_delete)
                TYPE_EMPTY -> SimpleViewHolder(R.layout.item_pay_password_empty)
                else -> ViewHolder()
            }
        }

        private inner class ViewHolder : AppViewHolder(R.layout.item_pay_password_normal) {
