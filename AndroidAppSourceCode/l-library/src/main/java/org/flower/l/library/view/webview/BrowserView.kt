package org.flower.l.library.view.webview
...
import org.flower.l.library.dialog.InputDialog
import org.flower.l.library.dialog.MessageDialog
import org.flower.l.library.dialog.TipsDialog
import org.flower.l.library.other.PermissionCallback
import java.util.*
    ...
    open class BrowserChromeClient constructor(private val webView: BrowserView) :
        ...
        override fun onJsAlert(
            ...
            TipsDialog.Builder(activity)
                .setIcon(TipsDialog.TipsIcon.ICON_WARNING.image)
                .setMessage(message)
                .setCancelable(false)
        ...
        override fun onShowFileChooser(
            ...
            if (activity !is BaseWebActivity<*>) {
                return false
            }
            XXPermissions.with(activity)
        ...
        private fun openSystemFileChooser(
            ...
            activity.startActivityForResult(
                ...
                object : BaseWebActivity.OnActivityCallback {
