...
import org.flower.l.library.adapter.AppAdapter
import org.flower.l.library.adapter.TabAdapter
import org.flower.l.library.aop.SingleClick
import org.flower.l.library.base.BaseDialog
import org.flower.l.library.util.DensityExt
...
class AddressDialog {
    ...
    class AddressAdapter constructor(context: Context) : AppAdapter<AddressBean?>(context) {
        ...
        private val dp20 = DensityExt.dp2Pix(context, 20f)
        private val dp10 = DensityExt.dp2Pix(context, 10f)
        ...
        override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder {
            ...
            textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, 14.sp)
            textView.layoutParams = ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.WRAP_CONTENT
            )
            textView.setPadding(dp20, dp10, dp20, dp10)
